...
function ChatHome(R) {
  ...
  return jsxs(Fragment, { children: [
    ...
    // 小吉祥物：虎猴兔三动物（无动画，紧贴 chat 框上沿右侧，并排同高）
    ...
    jsx('div', {
      ...
      children: jsx('div', { style: { display: 'flex', alignItems: 'flex-end', gap: '2px' }, children: mascotSVGs(27) }),
    }),
...
function Drawer(R) {
  ...
  var acItems = (t.acceptance_criteria || []).map(function(a, i) {
    ...
    // 圆形状态标记（TodoList 风格）：未开始=空心细环 / 通过=绿底✓ / 未通过=红底✕；状态全靠图标表达，无汉字标签
    var mkBg = d ? GREEN : fl ? RED : 'transparent'
    var mkBd = d ? GREEN : fl ? RED : LINE2
    var mkFg = d ? '#fff' : fl ? '#fff' : 'transparent'
    return jsxs('div', {
      className: 'flex items-center gap-2.5 px-3 py-2 text-[0.75rem] pw-hover',
      ...
      children: [
        ...
        jsx('span', { className: 'flex-1 min-w-0 break-words', style: { color: fl ? DANGER : d ? MUT : BODY, textDecoration: d ? 'line-through' : 'none', transition: 'color .2s' }, children: txt }),
      ],
    }, i)
  })
        ...
        children: [
          ...
          jsxs('div', { style: { display: 'flex', flex: 1, overflow: 'hidden' }, children: [
            ...
            jsx('div', { style: { width: '50%', borderRight: '1px solid ' + LINE, overflowY: 'auto' }, children: jsxs('div', { style: { padding: '0 20px 20px 20px' }, children: [
              ...
              jsx(Sec, { label: '验收标准', children: acItems.length > 0 ? jsx('div', { className: 'overflow-hidden rounded-[5px]', style: { background: '#fff', boxShadow: SH_HAIR }, children: [
