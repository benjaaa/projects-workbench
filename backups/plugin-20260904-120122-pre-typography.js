                    ...
                    return jsxs('div', { style: { display: 'flex', gap: '12px', padding: '7px 0', position: 'relative' }, children: [
                      ...
                      jsxs('div', { style: { flex: 1, minWidth: 0 }, children: [
                        jsxs('div', { style: { display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '3px', flexWrap: 'wrap' }, children: [
                          ...
                          entry.logType === 'review' && entry.window && jsx('span', { style: { fontSize: '9px', color: FAINT, flexShrink: 0 }, children: entry.window }),
                        ...
                        editingYaml === entry.entryId
                          ...
                          : jsx('div', { style: { fontSize: '12px', color: INK, fontWeight: 500, lineHeight: 1.5, marginBottom: (entry.outputs.length || entry.decisions.length || entry.risks.length || entry.pending.length) ? '4px' : '0', cursor: 'text', title: entry.entryId ? '双击编辑' : '' }, onDoubleClick: function() { if (entry.entryId) setEditingYaml(entry.entryId) }, children: entry.summary }),
